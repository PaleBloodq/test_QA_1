...
import bootstrap
from tg_bot.app import register_dialogs
from tg_bot.app.dialogs import error_handler
from tg_bot.app.routes import register_routes

from tg_bot.web.api.routes import send_message_manager, send_message_payment
...
async def main():
    ...
    await runner.setup()
    site = web.TCPSite(runner, '0.0.0.0', os.environ.get('TELEGRAM_BOT_PORT'))
    print(site.name)
    await site.start()
