    ...
    return (
        <Container>
            <div className="w-full h-[38px] flex items-center justify-between">
                <input onChange={(e) => dispatch(setSearchValue(e.target.value))} value={inputValue} className="w-full bg-transparent outline-none text-header" type="text" placeholder="Найти игру..." />
                ...
                <button className="w-[38px] h-[38px] rounded-xl bg-[#f6f7fa] border border-[#e7e7e8] dark:border-none dark:bg-[#FFFFFF0D] flex flex-shrink-0 items-center justify-center">
