    ...
    return (
        <div className="absoulte top-0 left-0 w-full h-full">
            <div className="w-full flex justify-between items-center mb-7">
                ...
                <button onClick={() => { setShowFilter(false); resetFilter() }} className="w-[38px] h-[38px] rounded-xl bg-[#f6f7fa] border border-[#e7e7e8] dark:border-none dark:bg-[#FFFFFF0D] flex flex-shrink-0 items-center justify-center mx-2">
